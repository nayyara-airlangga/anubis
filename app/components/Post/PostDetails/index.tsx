...
const PostDetails = ({ post }: { post: Post }) => {
  ...
  return (
    <div>
      ...
      <Markdown className="max-w-full w-full prose dark:prose-invert tablet:prose-img:w-3/5 prose-img:w-full prose-img:mx-auto prose-a:text-blue-400 prose-code:text-[14px] break-words overflow-x-auto">
        {post.content}
      </Markdown>
    </div>
  )
